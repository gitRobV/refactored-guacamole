...
var ApiService = (function () {
    ...
    ApiService.prototype.regNewUser = function (newUser) {
        return this._http.post('/api/create', newUser).map(function (Response) { return Response.json(); }).toPromise();
    };
    ApiService.prototype.getCurrentUser = function () {
        return this._http.get('/api').map(function (Response) { return Response.json(); }).toPromise();
    };
    ApiService.prototype.authenticate = function (user) {
        return this._http.post('/api/auth', user).map(function (Response) { return Response.json(); }).toPromise();
    };
    ApiService.prototype.checkAuth = function () {
        return this._http.get('/api/auth-check').map(function (Response) { return Response.json(); }).toPromise();
    };
...
var AppComponent = (function () {
    function AppComponent(_apiService, _router) {
        ...
        this.title = 'Welcome To Mean Black Belt';
    }
...
var LoginComponent = (function () {
    ...
    LoginComponent.prototype.login = function (user_info) {
        var _this = this;
...
module.exports = "<div class=\"col-sm-4 col-sm-offset-4\" >\n    <div class=\"center\">\n        <a class=\"button\" *ngIf=\"user\" [routerLink]=\"['/profile']\">Profile</a>\n        <a class=\"button\" *ngIf=\"user\" (click)=\"logout()\">Log Out</a>\n    </div>\n</div>\n<div class=\"card\">\n    <h4>List of other Users</h4>\n    <p *ngFor=\"let user of allUsers\"><button>{{ user.email }}</button></p>\n</div>\n"
...
var RegisterComponent = (function () {
    ...
    RegisterComponent.prototype.registerUser = function (user_info) {
        var _this = this;
        // Call api Service to Create User
